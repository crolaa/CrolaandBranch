...
-- Used when the model has eye bones; head entries above are skipped in ShootMatrix
male["ValveBiped.Bip01_L_Eye"] = {
	{
		"eyeL",
		nil,
		Vector(0.2, 0, 0),
		Angle(0, 0, 0),
		Vector(0.65, 0.45, 0.65),
		Color(255, 255, 0)
	},
}
male["ValveBiped.Bip01_R_Eye"] = {
	{
		"eyeR",
		nil,
		Vector(0.2, 0, 0),
