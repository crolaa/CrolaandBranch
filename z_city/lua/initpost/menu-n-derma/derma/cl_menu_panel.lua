local PANEL = {}
local curent_panel 
local red_select = Color(255,120,0)
...
local text = "<font=ZC_MM_Title><colour=255,120,0,255>Crolaand</colour></font>"
  return markup.Parse(text)
end

local color_red = Color(255,120,0,45)
...
local clr_1 = Color(255,120,0,35)
