local MODE = MODE
local vgui_color_main = Color(255,120,0, 255)
...
local vgui_color_text_main = Color(255,120,0, 0, 255)
...
local traitor_panel = {
    ...
    avatar_materials = {}, 
    colors = {
        bg = Color(255,120,0, 230),
        border = Color(255,90,0, 255),
        border_inner = Color(255,120,0, 150),
        title = Color(255, 255, 255, 255),
        words = Color(255, 80, 80, 255),
        assistant = Color(150, 70, 70, 255)
    }
}
